...
public class ColumnMetadataImpl implements ColumnMetadata {
  ...
  public static ColumnMetadataImpl fromPropertiesConfiguration(String column, PropertiesConfiguration config) {
    ...
    builder.setFieldSpec(buildFieldSpec(column, config));
    ...
    if (minString != null && maxString != null) {
      setMinMaxValues(builder, storedType, minString, maxString);
    }
    ...
    setPartitionFunction(column, config, builder);

    return builder.build();
  }

  private static void setPartitionFunction(String column, PropertiesConfiguration config, Builder builder) {
    ...
    if (partitionFunctionName != null) {
      ...
      if (!partitionFunctionConfig.isEmpty()) {
        partitionFunctionConfigMap = extractPartitionFunctionConfigMap(partitionFunctionConfig);
      }
  ...
  private static Map<String, String> extractPartitionFunctionConfigMap(Configuration partitionFunctionConfig) {
    Map<String, String> partitionFunctionConfigMap = new HashMap<>();
    ...
    return partitionFunctionConfigMap;
  }

  private static FieldSpec buildFieldSpec(String column, PropertiesConfiguration config) {
    FieldType fieldType =
  ...
  private static void setMinMaxValues(Builder builder, DataType storedType, String minString, String maxString) {
    switch (storedType) {
      case INT:
